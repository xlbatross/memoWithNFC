package com.project.memowithnfc.categorymemoView;
...
public class CategoryMemoAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private ArrayList<Memo> mList;

    public CategoryMemoAdapter(Context context, ArrayList<Memo> list) {
